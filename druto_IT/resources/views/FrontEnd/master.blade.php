...
<!-- Mirrored from templates.envytheme.com/strax/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Dec 2021 06:11:46 GMT -->
<head>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu mega-dropdown-menu">
                                <li class="nav-item">
                                    ...
                                    <a href="index.html" class="nav-link active">Home One (IT Startup)</a>
                                    <a href="index-it-2.html" class="nav-link">Home Two (IT Startup)</a>
                                    <a href="index-it-3.html" class="nav-link">Home Three (IT Startup)</a>
                                    <a href="index-saas.html" class="nav-link">Home Four (SaaS Startup)</a>
                                    <a href="index-3.html" class="nav-link">Home Five (Chatbot)</a>
                                    <a href="index-4.html" class="nav-link">Home Six (Chatbot)</a>
                                    <a href="index-5.html" class="nav-link">Home Seven (Chatbot)</a>
                                    <a href="index-digital-marketing-agency.html" class="nav-link">Home Eight (Digital Marketing Agency)</a>
                                </li>
                                <li class="nav-item">
                                    <h3>Without Animation</h3>
                                    <a href="index-without-animation.html" class="nav-link">Home One (IT Startup)</a>
                                    <a href="index-it-2-without-animation.html" class="nav-link">Home Two (IT Startup)</a>
                                    <a href="index-it-3-without-animation.html" class="nav-link">Home Three (IT Startup)</a>
                                    <a href="index-saas-without-animation.html" class="nav-link">Home Four (SaaS Startup)</a>
                                    <a href="index-3-without-animation.html" class="nav-link">Home Five (Chatbot)</a>
                                    <a href="index-4-without-animation.html" class="nav-link">Home Six (Chatbot)</a>
                                    <a href="index-5-without-animation.html" class="nav-link">Home Seven (Chatbot)</a>
                                    <a href="index-digital-marketing-agency-without-animation.html" class="nav-link">Home Eight (Digital Marketing Agency)</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="d-table">
                        <div class="d-table-cell">
                            <div class="animate-banner-image">
                                <img src="{{asset('frontend')}}/assets/img/animate-banner-img1.jpg" alt="image">
                            </div>
                        </div>
                    </div>
                    <img src="{{asset('frontend')}}/assets/img/banner-slider/banner-img1.jpg" class="mbanner-img" alt="image">
                </div>
            </div>
        </div>
    </div>
    <div class="shape20"><img src="{{asset('frontend')}}/assets/img/shape/19.png" alt="image"></div>
    <div class="shape21"><img src="{{asset('frontend')}}/assets/img/shape/20.png" alt="image"></div>
    <div class="shape19"><img src="{{asset('frontend')}}/assets/img/shape/18.png" alt="image"></div>
    <div class="shape22"><img src="{{asset('frontend')}}/assets/img/shape/21.png" alt="image"></div>
    <div class="shape23"><img src="{{asset('frontend')}}/assets/img/shape/22.svg" alt="image"></div>
    <div class="shape24"><img src="{{asset('frontend')}}/assets/img/shape/23.png" alt="image"></div>
    <div class="shape26"><img src="{{asset('frontend')}}/assets/img/shape/25.png" alt="image"></div>
</div>
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay=".2s">
                <div class="single-features-card tx-center">
                    ...
                    <h3>
                        <a href="single-service.html">IT Consultancy</a>
                    </h3>
            ...
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay=".3s">
                <div class="single-features-card tx-center">
                    ...
                    <h3>
                        <a href="single-service.html">Web Development</a>
                    </h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor dolore magna aliqua.</p>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay=".4s">
                <div class="single-features-card tx-center">
                    ...
                    <h3>
                        <a href="single-service.html">IT Solutions</a>
                    </h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor dolore magna aliqua.</p>
                </div>
            </div>
        ...
        <div class="row align-items-center">
            <div class="services-content it-service-content">
                <div class="content left-content">
                    ...
                    <a href="single-service.html" class="default-btn">
            ...
            <div class="services-image wow fadeInRight" data-wow-delay=".3s">
                <div class="image">
                    <img src="{{asset('frontend')}}/assets/img/services-image/service1.png" alt="image">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="services-image wow fadeInLeft" data-wow-delay=".3s">
                <div class="image">
                    <img src="{{asset('frontend')}}/assets/img/services-image/service2.png" alt="image">
                </div>
            </div>
            <div class="services-content it-service-content">
                <div class="content">
...
<section class="video-presentation-area ptb-100">
    <div class="container">
        ...
        <div class="video-box">
            <img src="{{asset('frontend')}}/assets/img/video-bg.jpg" class="main-image" alt="image">
            <a href="https://www.youtube.com/watch?v=0gv7OC9L2s8" class="video-btn popup-youtube">
                <i class="bx bx-play"></i>
            </a>
            <div class="shape1"><img src="{{asset('frontend')}}/assets/img/shape/1.png" alt="image"></div>
            <div class="shape2"><img src="{{asset('frontend')}}/assets/img/shape/2.png" alt="image"></div>
            <div class="shape3"><img src="{{asset('frontend')}}/assets/img/shape/3.png" alt="image"></div>
            <div class="shape4"><img src="{{asset('frontend')}}/assets/img/shape/4.png" alt="image"></div>
            <div class="shape5"><img src="{{asset('frontend')}}/assets/img/shape/5.png" alt="image"></div>
            <div class="shape6"><img src="{{asset('frontend')}}/assets/img/shape/6.png" alt="image"></div>
        </div>
    ...
    <div class="shape-map1"><img src="{{asset('frontend')}}/assets/img/map1.png" alt="image"></div>
    <div class="shape7"><img src="{{asset('frontend')}}/assets/img/shape/7.png" alt="image"></div>
    <div class="shape8"><img src="{{asset('frontend')}}/assets/img/shape/8.png" alt="image"></div>
    <div class="shape9"><img src="{{asset('frontend')}}/assets/img/shape/9.png" alt="image"></div>
</section>
    ...
    <div class="container">
        ...
        <div class="feedback-slides owl-carousel owl-theme">
            <div class="single-feedback-item">
                <img src="{{asset('frontend')}}/assets/img/woman1.png" alt="image">
            ...
            <div class="single-feedback-item">
                <img src="{{asset('frontend')}}/assets/img/woman2.png" alt="image">
                <div class="feedback-desc">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse.</p>
                    <div class="rating">
                        <i class="bx bxs-star"></i>
            ...
            <div class="single-feedback-item">
                <img src="{{asset('frontend')}}/assets/img/man1.png" alt="image">
                <div class="feedback-desc">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse.</p>
                    <div class="rating">
                        <i class="bx bxs-star"></i>
                            ...
                            <div class="single-pricing-table left-align">
                                ...
                                <ul class="pricing-features">
                                    <li>
                                        ...
                                        <span class="tooltips bx bxs-info-circle" data-bs-toggle="tooltip" data-bs-placement="right" title="Tight pants next level keffiyeh you probably haven't heard of them."></span>
                                    </li>
                                    <li>
                                        <i class="bx bxs-badge-check"></i>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="single-pricing-table left-align">
                                ...
                                <ul class="pricing-features">
                                    ...
                                    <li>
                                        <i class="bx bxs-badge-check"></i>
                                        Visitor Notes <span class="tooltips bx bxs-info-circle" data-bs-toggle="tooltip" data-bs-placement="right" title="Tight pants next level keffiyeh you probably haven't heard of them."></span>
                                    </li>
                                    <li><i class="bx bxs-badge-check"></i> Google Analytics</li>
                                </ul>
                                <div class="btn-box">
                        ...
                        <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                            <div class="single-pricing-table left-align">
                                ...
                                <div class="btn-box">
                                    <a href="contact.html" class="default-btn"><i class="bx bxs-hot"></i> Try It Free Now <span></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<section class="team-area pt-100 pb-70">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-team-box wow fadeInUp" data-wow-delay=".3s">
                    <div class="image">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="single-team-box wow fadeInUp" data-wow-delay=".5s">
                    <div class="image">
    ...
    <div class="container">
        ...
        <div class="clients-logo-list align-items-center">
            <div class="single-clients-logo">
                <a href="#">
                    <img src="{{asset('frontend')}}/assets/img/clients-image/1.png" alt="image">
                </a>
            </div>
            <div class="single-clients-logo">
                <a href="#">
                    <img src="{{asset('frontend')}}/assets/img/clients-image/2.png" alt="image">
                </a>
            </div>
            <div class="single-clients-logo">
                <a href="#">
                    <img src="{{asset('frontend')}}/assets/img/clients-image/3.png" alt="image">
                </a>
            </div>
            <div class="single-clients-logo">
                <a href="#">
                    <img src="{{asset('frontend')}}/assets/img/clients-image/4.png" alt="image">
                </a>
            </div>
            <div class="single-clients-logo">
                <a href="#">
                    <img src="{{asset('frontend')}}/assets/img/clients-image/5.png" alt="image">
                </a>
            </div>
            <div class="single-clients-logo">
                <a href="#">
                    <img src="{{asset('frontend')}}/assets/img/clients-image/6.png" alt="image">
                </a>
            </div>
            <div class="single-clients-logo">
                <a href="#">
                    <img src="{{asset('frontend')}}/assets/img/clients-image/7.png" alt="image">
                </a>
            </div>
            <div class="single-clients-logo">
                <a href="#">
                    <img src="{{asset('frontend')}}/assets/img/clients-image/8.png" alt="image">
                </a>
            </div>
            <div class="single-clients-logo">
                <a href="#">
                    <img src="{{asset('frontend')}}/assets/img/clients-image/9.png" alt="image">
                </a>
            </div>
        </div>
    </div>
...
<section class="faq-area ptb-100">
    <div class="container-fluid">
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 col-md-12">
                <div class="faq-image">
                    <img src="{{asset('frontend')}}/assets/img/faq-img1.png" alt="image">
                </div>
            </div>
        </div>
    </div>
...
<div class="subscribe-content border-radius-0">
    ...
    <div class="shape14"><img src="{{asset('frontend')}}/assets/img/shape/13.png" alt="image"></div>
    <div class="shape15"><img src="{{asset('frontend')}}/assets/img/shape/14.png" alt="image"></div>
    <div class="shape16"><img src="{{asset('frontend')}}/assets/img/shape/15.png" alt="image"></div>
    <div class="shape17"><img src="{{asset('frontend')}}/assets/img/shape/16.png" alt="image"></div>
    <div class="shape18"><img src="{{asset('frontend')}}/assets/img/shape/17.png" alt="image"></div>
</div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-blog-post">
                    <div class="post-image">
                        ...
                        <div class="date"><i class='bx bx-calendar'></i> Oct 14, 2021</div>
                    </div>
                    <div class="post-content">
                        <h3><a href="single-blog.html">50 world-changing people, We lost in the 2010s</a></h3>
                        <div class="post-info">
                            <div class="post-by">
                                <img src="{{asset('frontend')}}/assets/img/author-image/1.jpg" alt="image">
                                <h6>Sarah Taylor</h6>
                            </div>
                            <div class="details-btn">
                                <a href="single-blog.html"><i class="bx bx-right-arrow-alt"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-blog-post">
                    <div class="post-image">
                        ...
                        <div class="date"><i class='bx bx-calendar'></i> Oct 16, 2021</div>
                    </div>
                    <div class="post-content">
                        <h3><a href="single-blog.html">Don't buy a tech gift until you read these rules</a></h3>
                        <div class="post-info">
                            <div class="post-by">
                                <img src="{{asset('frontend')}}/assets/img/author-image/2.jpg" alt="image">
                                <h6>Michel John</h6>
                            </div>
                            <div class="details-btn">
                                <a href="single-blog.html"><i class="bx bx-right-arrow-alt"></i></a>
            ...
            <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                <div class="single-blog-post">
                    <div class="post-image">
                        ...
                        <div class="date"><i class='bx bx-calendar'></i> Oct 18, 2021</div>
                    </div>
                    <div class="post-content">
                        <h3><a href="single-blog.html">The golden rule of buying a phone as a gift</a></h3>
                        <div class="post-info">
                            <div class="post-by">
                                <img src="{{asset('frontend')}}/assets/img/author-image/3.jpg" alt="image">
                                <h6>Lucy Eva</h6>
                            </div>
                            <div class="details-btn">
                                <a href="single-blog.html"><i class="bx bx-right-arrow-alt"></i></a>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-footer-widget">
                    <div class="logo">
                        <a href="index.html"><img src="{{asset('frontend')}}/assets/img/white-logo.png" alt="image"></a>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-footer-widget">
                    ...
                    <ul class="footer-contact-info">
                        ...
                        <li>Email: <a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#4129242d2d2e0132353320396f222e2c"><span class="__cf_email__" data-cfemail="b0d8d5dcdcdff0c3c4c2d1c89ed3dfdd">[email&#160;protected]</span></a></li>
...
<script src="{{asset('frontend')}}/assets/js/conversation.js"></script>
...
<script src="{{asset('frontend')}}/assets/js/coustom-particles.js"></script>

<script src="{{asset('frontend')}}/assets/js/main.js"></script>
</body>

<!-- Mirrored from templates.envytheme.com/strax/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Dec 2021 06:12:10 GMT -->
</html>
